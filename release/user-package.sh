...
build_v2() {
	...
	LDFLAGS="-s -w -buildid= -X github.com/Shadowsocks-NET/v2ray-go/v4.codename=${CODENAME} -X github.com/Shadowsocks-NET/v2ray-go/v4.build=${BUILDNAME} -X github.com/Shadowsocks-NET/v2ray-go/v4.version=${VERSIONTAG}"
