...
type Policy_Timeout struct {
	...
	UdpIdle      *Second `protobuf:"bytes,2,opt,name=udp_idle,json=udpIdle,proto3" json:"udp_idle,omitempty"`
...
func (x *Policy_Timeout) GetUdpIdle() *Second {
	if x != nil {
		return x.UdpIdle
	}
	return nil
...
var file_app_policy_config_proto_rawDesc = []byte{
	...
	0x22, 0xc2, 0x04, 0x0a, 0x06, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x3f, 0x0a, 0x07, 0x74,
	...
	0x75, 0x66, 0x66, 0x65, 0x72, 0x1a, 0x84, 0x02, 0x0a, 0x07, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75,
	...
	0x6f, 0x6e, 0x64, 0x52, 0x09, 0x68, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x12, 0x38,
	0x0a, 0x08, 0x75, 0x64, 0x70, 0x5f, 0x69, 0x64, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x07, 0x75, 0x64, 0x70, 0x49, 0x64, 0x6c, 0x65, 0x12, 0x3e, 0x0a, 0x0b, 0x75, 0x70, 0x6c, 0x69,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x68, 0x0a, 0x19, 0x63, 0x6f,
	0x6d, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x70,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x50, 0x01, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_app_policy_config_proto_depIdxs = []int32{
	...
	0,  // 7: v2ray.core.app.policy.Policy.Timeout.udp_idle:type_name -> v2ray.core.app.policy.Second
